...
public class Regex_Ass3_Productname_Validity
{
	 ...
	 System.out.println("The product name is "+ (shipment.checkProductNameValidity(productName1) ? "valid!" : "invalid!"));
	 String productId1 = "DC191$";
	 System.out.println("The product Id is "+ (shipment.checkProductIdValidity(productId1) ? "valid!" : "invalid!"));
	 String trackerId1 = "D:CMDc:cmd:23";
	 System.out.println("The tracker Id is "+ (shipment.checkTrackerIdValidity(trackerId1) ? "valid!" : "invalid!"));
